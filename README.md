...
Inspired by the [StoryScope](https://arxiv.org/abs/2604.03136) (Russel Et. Al 2026) research methodology, this project automates the transition from raw academic literature to structured, prompt-driven synthetic data to study model behavior in domain-specific, unstructured writing tasks.
