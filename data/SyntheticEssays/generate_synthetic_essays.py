...
MODELS_TO_RUN: List[Dict[str, str]] = [
    {"model_id": "gemini-3.5-flash-lite", "label": "gemini_3.5flashlite"},
    # Uncomment to enable Qwen or other models:
    # {"model_id": "ollama/qwen2.5:14b",     "label": "qwen25_14b_local"},
    # {"model_id": "openrouter/qwen/qwen-2.5-72b-instruct", "label": "qwen25_72b_cloud"},
]

# 2. FAILURE LOG HELPERS
...
# 3. ZERO-SHOT GENERATION (STORYSCOPE METHODOLOGY)
...
def process_benchmark_prompts(
    prompts_file: str = "benchmark_prompts.json",
    output_dir: str = "raw_essays",
